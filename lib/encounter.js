        ...
        if (encounters) {
            for (var a=0;a<encounters.length;a++) {
                ...
                async.parallel([
                    // filter types
                    function(callback) {
                        // if there are types, and 'encounter_type' not null
                        if ((types) && (item.encounter_type)) {
                    ...
                    // filter form
                    function(callback) {
                        // if there are form, and 'form_id' not null
                        if ((forms) && (item.form_id)) {
