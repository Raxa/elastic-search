...
Application.prototype.start = function() {
    ...
    app.get('/patient',function(request,response) {
        patient.search(null,request.query,function(result){
            response.json(result);
            gc();
        });
    });
    app.get('/patient/:data',function(request,response) {
        patient.search(request.params.data,request.query,function(result){
            response.json(result);
            gc();
        });
    });
    ...
    app.get('/person',function(request,response) {
        person.search(null,request.query,function(result){
            response.json(result);
            gc();
        });
    });
    app.get('/person/:data',function(request,response) {
        person.search(request.params.data,request.query,function(result){
            response.json(result);
            gc();
        });
    });
